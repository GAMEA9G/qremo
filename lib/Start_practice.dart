        ...
        decoration: BoxDecoration(
         ...
         Align(alignment: Alignment.bottomCenter,child:  Row(spacing: 10,mainAxisAlignment:MainAxisAlignment.center, children: [
          FloatingActionButton(onPressed: (){
            ...
            },child: const Icon(Icons.edit),backgroundColor: ThemeProvider().themeMode == ThemeMode.dark ? yellowDark :yellowLight,foregroundColor: Theme.of(context).colorScheme.onSurface

            )
        ,FloatingActionButton.extended(onPressed: (){

            },label: Text("Start Practice", style: TextStyle(fontSize: 25),),backgroundColor: ThemeProvider().themeMode == ThemeMode.dark ? yellowDark :yellowLight,foregroundColor: Theme.of(context).colorScheme.onSurface)
